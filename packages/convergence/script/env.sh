...
# Agent Infrastructure (deployed via DeployAgentInfra.s.sol)
export AGENTS_CONTRACT="${AGENTS_CONTRACT:-0xa04cF1072A33B3FF4aB6bb1E054e69e66BaD5430}"
export AGENT_REGISTRY="${AGENT_REGISTRY:-0x2eDE9C65F4Ff33F4190aee798478bb579f248F52}"
export AGENT_STAKING="${AGENT_STAKING:-0xaFb6D74eD5286158312163671E93fba8A6Fd058e}"
export SEASONAL_LEADERBOARD="${SEASONAL_LEADERBOARD:-0x2C91eF4616f7D4386F27C237D77169395e9EfCE0}"
export PREDICTION_MARKET="${PREDICTION_MARKET:-0x1B995CC591Ec168df03339Fae74B0752Aa1259d8}"
export SHARED_PRICE_FEED="${SHARED_PRICE_FEED:-0x9AB27e309E677c0ec488E37E8F3B193958D2bBc7}"

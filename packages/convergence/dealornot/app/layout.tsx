  ...
  return (
    <html lang="en" className="dark">
      <body className={`${geistMono.variable} antialiased min-h-screen relative overflow-x-hidden crt-vignette noise-overlay`}>
        ...
        <ClientProviders>
          {children}
          <footer className="w-full py-3 text-center text-xs text-white/40 border-t border-white/5 space-y-1">
            <a href="https://github.com/rdobbeck/deal-or-not" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 hover:text-white/70 transition-colors">
              ...
              rdobbeck/deal-or-not
            </a>
            <p className="text-white/25">by Ryan, Claude, and Tippi Fifestarr</p>
          </footer>
        </ClientProviders>
      </body>
    </html>
